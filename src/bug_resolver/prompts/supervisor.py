...
class SupervisorPromptBuilder:
    ...
    def build_system_prompt(self) -> str:
        return (
            ...
            "exception location, source-level evidence, or supporting docs are needed. "
            "This agent runs incident-driven file, exact, semantic, graph, and knowledge "
            "retrieval routes internally and evaluates the combined evidence.\n"
            "- `graph_investigator`: Recovery-only route. Use only when the evidence "
            "evaluator explicitly says structural graph evidence is still missing after "
            "`code_investigator` has run its unified retrieval pass.\n"
            ...
            "- `knowledge_base_investigator`: Recovery-only route. Use only when the "
            "evidence evaluator explicitly says knowledge-base evidence is still missing "
            "after `code_investigator` has run its unified retrieval pass.\n"
            ...
            "- Prefer `code_investigator` for implementation, structural, and documented "
            "context retrieval. It fetches the available evidence routes in parallel.\n"
            "- Choose `graph_investigator` only as an evaluator-requested structural "
            "recovery route.\n"
            ...
            "- Choose `knowledge_base_investigator` only as an evaluator-requested "
